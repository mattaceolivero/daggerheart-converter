...
mkdir -p "$CLAUDE_SKILLS_DIR/dh-encounter"
...
cp "$SCRIPT_DIR/skills/dh-encounter/SKILL.md" "$CLAUDE_SKILLS_DIR/dh-encounter/"
...
if [ ! -f "$CLAUDE_SKILLS_DIR/dh-encounter/SKILL.md" ]; then
    echo "  ERROR: dh-encounter skill not found"
    MISSING=1
fi
...
if [ $MISSING -eq 0 ]; then
    ...
    echo "  /dh-encounter   - Generate random encounters"
    echo ""
